namespace _07.TheV_Logger
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((newActivity = Console.ReadLine().Split(' ', StringSplitOptions.RemoveEmptyEntries))[0] != "Statistics")
            {
                ...
                if (action == "joined")
                {
                    ...
                    {
                        Vlogger newVlogger = new Vlogger(firstVlogger, new SortedSet<string>(), new SortedSet<string>());
            ...
            int index = 1;
            Console.WriteLine($"{index}. {theMostFamous.Value.Name} : " +                                                $"{theMostFamous.Value.Followers.Count} followers, " +
        ...
        {
            return theVlogger.ContainsKey(firstVlogger)
